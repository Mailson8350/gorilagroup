...
export type SiteSettings = {
  ...
  digital_card_name: string;
  digital_card_title: string;
  digital_card_company: string;
  digital_card_description: string;
  digital_card_phone: string;
  digital_card_email: string;
  digital_card_whatsapp: string;
  digital_card_website: string;
  digital_card_linkedin: string;
  digital_card_photo: string;
...
export const SITE_CONFIG_KEYS = Object.keys({
  ...
  digital_card_name: "Carlos Pereira",
  digital_card_title: "CEO",
  digital_card_company: "Grupo Gorila Holding",
  digital_card_description: "Executivo com visão estratégica para expansão internacional, inovação e criação de valor em ambientes corporativos de alto impacto.",
  digital_card_phone: "+351 910 000 000",
  digital_card_email: "carlos@grupogorila.com",
  digital_card_whatsapp: "+351910000000",
  digital_card_website: "https://www.grupogorila.com",
  digital_card_linkedin: "https://www.linkedin.com",
  digital_card_photo: "/carlos-ceo.svg",
  social_facebook: "",
  social_instagram: "",
  social_linkedin: "",
  social_tiktok: "",
